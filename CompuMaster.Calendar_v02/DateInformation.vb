...
#Region "Week functions"
        ...
        Public Shared Function WeekOfYear(ByVal dateValue As Date, ByVal cultureInfo As System.Globalization.CultureInfo) As WeekNumber
            Dim Result As New WeekNumber With {
                .Week = cultureInfo.DateTimeFormat.Calendar.GetWeekOfYear(dateValue, System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat.CalendarWeekRule, System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat.FirstDayOfWeek)
            }
